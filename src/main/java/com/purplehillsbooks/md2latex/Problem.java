 ...
 *
 * <p>An {@link Severity#ERROR} means the generated LaTeX would not compile, or would silently lose
 * content; the build stops. A {@link Severity#WARNING} is reported but does not stop anything.
 *
...
public record Problem(
    ...
    /**
     * Renders the problem the way a compiler would: location, message, an excerpt of the offending
